...
export const SAVED_ACCOUNT_3 =
  "GDN4IEVFP7UN6CECGZKZWIZQ2YPH7OENTIYM6WWCTZC76SPBB6KAOO3V";
export const SAVED_ACCOUNT_3_RECOVERY_PHRASE =
  "guess actor achieve brave pencil relax gold round actor rigid chuckle student pill mean health genius human wheat unaware rival arctic empty fork wolf";
export const SAVED_ACCOUNT_3_SECRET =
  "SC5J2ZWEDYOMEEUUU3DOMHCZNBTXXYMNCCQOTNOKMYU62HE2BJWT7SPE";
...
const SAVED_RPC_ENDPOINTS = [
  ...
  },
  {
    ...
    params: {
      tx: "",
    ...
    payload: {
      ...
      params: {
        transaction:
          "",
...
const SAVED_TRANSACTIONS = [
  {
    ...
    xdr: "",
    page: "submit",
    shareableUrl:
  ...
  },
  {
    ...
    xdr: "AAAAAgAAAAA55ZjOXdOOulfzeLPXjLDLdplq/5HGjapWAXjGSkdAkwAAAMgADQioAAAAAQAAAAAAAAAAAAAAAgAAAAAAAAAAAAAAAPhdN05mkM4xHi+T01SNgtsaiwQnrlbvzEup1jqlpjEnAAAAAlQL5AAAAAAAAAAAAQAAAAD4XTdOZpDOMR4vk9NUjYLbGosEJ65W78xLqdY6paYxJwAAAAAAAAAAO5rKAAAAAAAAAAAA",
    page: "build",
    shareableUrl:
