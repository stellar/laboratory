  ...
  test.describe("Operation", () => {
    ...
    test.describe("Create Account", () => {
      test("Happy path", async ({ page }) => {
        ...
        await expect(txnSuccess.getByText("Hash").locator("+ div")).toHaveText(
          "84f7a4f0ce4d703d2c5b51946fe5297bc33ee6daf29faf66f31a9c36335ce2d1",
        );
        await expect(txnSuccess.getByText("XDR").locator("+ div")).toHaveText(
          "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAAAAAAALbdmAQS9vS6yFAAp7g+/+xxUbbMaLA2DDkQvlh36VAmAAAAAACYloAAAAAAAAAAAA==",
        );
      });
    ...
    test.describe("Payment", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "0bee8d16c0ca068e0b9738217cee98dec890c276629b8e00e6c2bc409990f923",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAABAAAAALbdmAQS9vS6yFAAp7g+/+xxUbbMaLA2DDkQvlh36VAmAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAAAJiWgAAAAAAAAAAA",
        });
      });
    ...
    test.describe("Path Payment Strict Send", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "753dde6a60b7534ca85476cd9f37b890b6388202166a3f3e062972df2bff4188",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAANAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAAAJiWgAAAAAC23ZgEEvb0ushQAKe4Pv/scVG2zGiwNgw5EL5Yd+lQJgAAAAAAAAAAAJiWgAAAAAEAAAAAAAAAAAAAAAA=",
        });
      });
    ...
    test.describe("Path Payment Strict Receive", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "22c0c4099ab51137dd3bb1e30e1892d90a669f3ca05f9f1ffe913906ac15b255",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAACAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAAAJiWgAAAAAC23ZgEEvb0ushQAKe4Pv/scVG2zGiwNgw5EL5Yd+lQJgAAAAAAAAAAAJiWgAAAAAEAAAAAAAAAAAAAAAA=",
        });
      });
    });
    ...
    test.describe("Manage Sell Offer", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "c6b05f82dfff2eabf82d9ec1336c6c1df3db9e29fa7606c5b101600d4c2ea880",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAADAAAAAAAAAAFVU0RDAAAAAEI+fQXy7K+/7BkrIVo/G+lq7bjY5wJUq+NBPgIH3layAAAAAACYloAAAAACAAAAAQAAAAAAAAAAAAAAAAAAAAA=",
        });
      });
    ...
    test.describe("Manage Buy Offer", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "7bd56c1d1938b3348ed5264b0986603ab97e46f75a4fa7afee49894c348b7d48",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAMAAAAAAAAAAFVU0RDAAAAAEI+fQXy7K+/7BkrIVo/G+lq7bjY5wJUq+NBPgIH3layAAAAAACYloAAAAACAAAAAQAAAAAAAAAAAAAAAAAAAAA=",
        });
      });
    });
    ...
    test.describe("Create Passive Sell Offer", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "3d5480034168831d5c2bd2ba085b2527a5bd794d3974c3d17f693f4f5058789e",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAEAAAAAAAAAAFVU0RDAAAAAEI+fQXy7K+/7BkrIVo/G+lq7bjY5wJUq+NBPgIH3layAAAAAACYloAAAAACAAAAAQAAAAAAAAAA",
        });
      });
    });
    ...
    test.describe("Set Options", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "0a6c64d864a2776ea98987d2392630c58b06e6afcaf7d4ba102ff938fd455f7d",
          xdr: "",
        });
      });
    ...
    test.describe("Change Trust", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "37699833d296e8f44852de1fca100a4e371dac6e8e5251cb2bafedde27069f8c",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAGAAAAAwAAAAAAAAAAAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAef/////////8AAAAAAAAAAA==",
        });
      });
    ...
    test.describe("Account Merge", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "8659565ebb6937ee4f4657a2f475dc1727e4758bcdd63c7fe7e041037e1f8b24",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAIAAAAALbdmAQS9vS6yFAAp7g+/+xxUbbMaLA2DDkQvlh36VAmAAAAAAAAAAA=",
        });
      });
    });
    ...
    test.describe("Manage Data", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "b60e10a68d7dc01493033e2ff4b13d957317ac2a39aeedf9b18cafa2d05b5a91",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAKAAAACVRlc3QgTmFtZQAAAAAAAAEAAAAKVGVzdCBWYWx1ZQAAAAAAAAAAAAA=",
        });
      });
    });
    ...
    test.describe("Bump Sequence", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "397b90b936644b1eaf258e0ae81c6b2ac45473a0d3e44e58eba75c77ef68961b",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAALAA/eUAAAAAIAAAAAAAAAAA==",
        });
      });
    ...
    test.describe("Create Claimable Balance", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "78e5fb41cc217c41e9b0f780a5ab7c357331f29a01338e83eb952e059a1823d4",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAOAAAAAAAAAAAAmJaAAAAAAQAAAAAAAAAAtt2YBBL29LrIUACnuD7/7HFRtsxosDYMORC+WHfpUCYAAAABAAAAAgAAAAUAAAAAZxKQ8AAAAAAAAAAAAAAAAA==",
        });
      });
    });
    ...
    test.describe("Claim Claimable Balance", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "e8ece24fa2351d800e853252d1550e2b267146c0f5bc5c271d99a1d5f4bfeb22",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAPAAAAADed89nn+QoN6A1FLgDsAhaPCEeUULqDcKrxPHZe6Yi9AAAAAAAAAAA=",
        });
      });
    ...
    test.describe("Begin and End Sponsoring Future Reserves", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "5c94129512d2127134bbf8cd6ba9647c21c6e7c35d01b33977c2c4bb795659d6",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAMgAD95QAAAAAQAAAAAAAAAAAAAAAgAAAAAAAAAQAAAAALbdmAQS9vS6yFAAp7g+/+xxUbbMaLA2DDkQvlh36VAmAAAAAAAAABEAAAAAAAAAAA==",
        });
      });
    });
    ...
    test.describe("Revoke Sponsorship", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "2655eb2f7b79716b7e61d2b5635b4af3d8b42510679ac4c4c419ab13224e97ea",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAASAAAAAAAAAAAAAAAAtt2YBBL29LrIUACnuD7/7HFRtsxosDYMORC+WHfpUCYAAAAAAAAAAA==",
        });
      });
    });
    ...
    test.describe("Clawback", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "9e5f94a88fffb01c3a6cc7f39d7caeef4fcbf71ae4de7597dabfeb0538f11565",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAATAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAAtt2YBBL29LrIUACnuD7/7HFRtsxosDYMORC+WHfpUCYAAAAAAJiWgAAAAAAAAAAA",
        });
      });
    });
    ...
    test.describe("Clawback Claimable Balance", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "8a318eb6d2307db5ec096a52ad97e995d2e376cb3cee05fc779001cee7b6ce0f",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAUAAAAADed89nn+QoN6A1FLgDsAhaPCEeUULqDcKrxPHZe6Yi9AAAAAAAAAAA=",
        });
      });
    });
    ...
    test.describe("Set Trust Line Flags", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "83f2583291ca4e798b8342b74dff48f331112fe2e9fddf2cd3485e434cda8f18",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAVAAAAALbdmAQS9vS6yFAAp7g+/+xxUbbMaLA2DDkQvlh36VAmAAAAAVVTREMAAAAAQj59BfLsr7/sGSshWj8b6WrtuNjnAlSr40E+AgfeVrIAAAAHAAAAAwAAAAAAAAAA",
        });
      });
    });
    ...
    test.describe("Liquidity Pool Deposit", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "0256ccd5e0a707fb97bd83ad9adfcccd8d152439f5281d422716f9541d91a4e8",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAWZyYMTBgHsmL/hRsKP+FBGUk2uwIVsvd0R/HfEZmOq7kAAAAAAJiWgAAAAAABMS0AAAAAAwAAAAEAAAAEAAAABQAAAAAAAAAA",
        });
      });
    ...
    test.describe("Liquidity Pool Withdraw", () => {
      test("Happy path", async ({ page }) => {
        ...
        await testOpSuccessHashAndXdr({
          page,
          hash: "737ac3fd2da60e3feb09256207475e45585103bb5dcd8e9cc74e0d75ff347633",
          xdr: "AAAAAgAAAAANLHqVohDTxPKQ3fawTPgHahe0TzJjJkWV1WakcbeADgAAAGQAD95QAAAAAQAAAAAAAAAAAAAAAQAAAAAAAAAXZyYMTBgHsmL/hRsKP+FBGUk2uwIVsvd0R/HfEZmOq7kAAAAAAJiWgAAAAAABMS0AAAAAAAHJw4AAAAAAAAAAAA==",
        });
      });
    });
