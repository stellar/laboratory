  ...
  test.describe("Saved transactions", () => {
    ...
    test.skip("Build item", async () => {
      ...
      await expect(
        ...
        "AAAAAgAAAAA55ZjOXdOOulfzeLPXjLDLdplq/5HGjapWAXjGSkdAkwAAAMgADQioAAAAAQAAAAAAAAAAAAAAAgAAAAAAAAAAAAAAAPhdN05mkM4xHi+T01SNgtsaiwQnrlbvzEup1jqlpjEnAAAAAlQL5AAAAAAAAAAAAQAAAAD4XTdOZpDOMR4vk9NUjYLbGosEJ65W78xLqdY6paYxJwAAAAAAAAAAO5rKAAAAAAAAAAAA",
      );
    });
