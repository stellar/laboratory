    ...
    <div className="XdrViewer__setup so-back">
      <div className="so-chunk">
        <div className="pageIntro">
          <p><a href="https://developers.stellar.org/docs/glossary/xdr/">External Data Representation (XDR)</a> is a standardized protocol that the Stellar network uses to encode data.</p>
