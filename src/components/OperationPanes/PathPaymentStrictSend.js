  ...
  return [
    ...
    <OptionsTablePair label="Send amount" key="sendMax">
      <AmountPicker
        ...
        onUpdate={(value) => {props.onUpdate('sendAmount', value)}}
        />
    </OptionsTablePair>,
    ...
    <OptionsTablePair label="Destination Asset" key="destAsset">
      <AssetPicker
        ...
        />
      <p className="optionsTable__pair__content__note">The minimum amount the destination can receive.</p>
    </OptionsTablePair>,
    <OptionsTablePair label="Minimum destination amount" key="destMin">
      <AmountPicker
        value={props.values['destMin']}
        onUpdate={(value) => {props.onUpdate('destMin', value)}}
        />
    </OptionsTablePair>,
  ];
}
